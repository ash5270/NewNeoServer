...
void neo::server::S2SSession::SendPacket(neo::packet::login::Packet& packet)
{
...
void neo::server::S2SSession::SetProcess(const std::shared_ptr<process::LoginProcess>& process)
{
	mProcess = process;
}
