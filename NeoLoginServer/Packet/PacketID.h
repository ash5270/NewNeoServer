...
using namespace neo::system;namespace neo::packet::login {
...
enum class PacketID : int32_t {
	...
	PI_C_REQ_CREATE_ID_CHECK=900,
	PI_C_REQ_CREATE_ID=901,
	PI_S_RES_CREATE_ID=902,
	...
	PI_C_REQ_PLAYER_ATTACK=5000,
	PI_S_RES_PLAYER_ATTACK=5001,
	PI_S_REQ_DB_LOGIN=10000,
	PI_S_RES_DB_LOGIN=10001,
	PI_S_REQ_DB_ID_CHECK=10010,
	PI_S_REQ_DB_ID_CREATE=10011,
	PI_S_RES_DB_ID_CREATE=10012,
